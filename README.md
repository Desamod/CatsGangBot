...
## [Settings](https://github.com/Desamod/CatsGangBot/blob/master/.env-example/)
...
## Installation
You can download the [**repository**](https://github.com/Desamod/CatsGangBot) by cloning it to your system and installing the necessary dependencies:
```shell
...
### Usages
When you first launch the bot, create a session for it using the 'Creates a session' command. It will create a 'sessions' folder in which all accounts will be stored, as well as a file account.json with configurations.
